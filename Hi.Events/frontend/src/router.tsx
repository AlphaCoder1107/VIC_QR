...
const EnrollmentLookupPageLazy = React.lazy(() => import("./pages/public/EnrollmentLookup"));
...
const Root = () => {
    ...
    useEffect(() => {
        if (me.isFetched) {
            ...
            } else if (!getConfig('VITE_EVENT_ID')) {
...
export const router: RouteObject[] = [
    ...
    },
    {
        ...
        children: [
            ...
            },
            {
                path: "student-roster",
                async lazy() {
                    const StudentRoster = await import("./pages/organiser/events/StudentRoster");
                    return { Component: StudentRoster.default };
                }
            },
            {
    ...
    },
    {
        ...
        async lazy() {
            const EnrollmentLookup = await import("./pages/public/EnrollmentLookup");
            return { Component: EnrollmentLookup.default };
        },
        errorElement: <ErrorPage />,
    },
    {
