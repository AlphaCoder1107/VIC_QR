                ...
                <div className={classes.welcomeHeader}>
                    <div className={classes.logo}>
                        {getConfig("VITE_APP_LOGO_LIGHT") ? (
                            ...
                            <span style={{ fontSize: '1.8rem', fontWeight: 800, color: '#fff', letterSpacing: '0.05em', fontFamily: 'Outfit, Inter, sans-serif' }}>
                    ...
                    <h1 className={classes.welcomeTitle}>
                        <Trans>
                            Welcome to {getConfig("VITE_APP_NAME", "CodePode")}, {userData?.first_name} 👋
                        </Trans>
                    </h1>
                </div>
